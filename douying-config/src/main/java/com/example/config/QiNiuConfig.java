...
public class QiNiuConfig {
    ...
    public static final String CNAME = "http://sewtmjph2.hd-bkt.clouddn.com";
    public static final String VIDEO_URL = "http://sewtmjph2.hd-bkt.clouddn.com";
    public static final String IMAGE_URL = "http://sewtmjph2.hd-bkt.clouddn.com";
